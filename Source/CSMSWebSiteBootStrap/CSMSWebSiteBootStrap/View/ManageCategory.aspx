                    ...
                    <div class="page-content">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <table align="center">
                                                    <tbody>
                                                        <tr>
                                                            <td><asp:Label ID="lblCategoryID" runat="server" Text="ID:" CssClass="form-control-static"></asp:Label></td>
                                                            <td><asp:TextBox ID="txtCategoryID" runat="server" ReadOnly="true" CssClass="form form-control"></asp:TextBox></td>
                                                        </tr>
                                                        <tr>
                                                            <td><asp:Label ID="lblCategoryName" runat="server" Text="Name: " CssClass="form-control-static"></asp:Label></td>
                                                            <td><asp:TextBox ID="txtCategoryName" runat="server" CssClass="form form-control" ></asp:TextBox></td>
                                                        </tr>
                                                        <tr>
                                                            <td><asp:Label ID="lblCategoryDescription" runat="server" Text="Description: " CssClass="form-control-static"></asp:Label></td>
                                                            <td><asp:TextBox ID="txtCategoryDescription" runat="server" TextMode="MultiLine" CssClass="form form-control"></asp:TextBox></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                ...
                                <asp:UpdatePanel ID="upModal1" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                <h4 class="modal-title"><asp:Label ID="lblModalTitle1" runat="server" Text=""></asp:Label></h4>
                                            </div>
                                            <div class="modal-body">
                                                <table align="center">
                                                    <tbody>
                                                        <tr>
                                                            <td><asp:Label ID="lblCategoryName1" runat="server" Text="Name: " CssClass="form-control-static"></asp:Label></td>
                                                            <td><asp:TextBox ID="txtCategoryName1" runat="server" CssClass="form form-control" ></asp:TextBox></td>
                                                        </tr>
                                                        <tr>
                                                            <td><asp:Label ID="lblCategoryDescription1" runat="server" Text="Description: " CssClass="form-control-static"></asp:Label></td>
                                                            <td><asp:TextBox ID="txtCategoryDescription1" runat="server" TextMode="MultiLine" CssClass="form form-control"></asp:TextBox></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-yellow">
                                <div class="panel-heading">Category <asp:Button ID="btnShowAddDialog" runat="server" class="btn btn-success" Text="Add New" OnClick="btnShowAddDialog_Click"></asp:Button></div>
                                <div class="panel-body">
                                    <div class="input-icon right text-white">
                                        <a href="#"><i class="fa fa-search"></i></a><asp:TextBox ID="txtCategorySearch" runat="server" placeholder="Search here..." class="form-control text-black"></asp:TextBox>                                        
                                    </div>

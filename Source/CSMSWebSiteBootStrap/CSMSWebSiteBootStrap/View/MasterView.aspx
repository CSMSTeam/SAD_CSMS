<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MasterView.aspx.cs" Inherits="CSMSWebSiteBootStrap.View.MasterView" %>
            ...
            <div id="header-topbar-option-demo" class="page-header-topbar">
                ...
                <div class="news-update-box hidden-xs"><span class="text-uppercase mrm pull-left text-white">News:</span>
                    ...
                    <ul class="nav navbar navbar-top-links navbar-right mbn">                   
                        <li class="dropdown topbar-user"><a data-hover="dropdown" href="#" class="dropdown-toggle"><img src="../Resource/image/me.jpg" alt="" class="img-responsive img-circle"/>&nbsp;<span class="hidden-xs">ChanhVQ</span>&nbsp;<span class="caret"></span></a>                       
                        </li>                    
                    </ul>
                </div>
            </nav>
            ...
            <div id="wrapper">
                ...
                <div class="sidebar-collapse menu-scroll">
                    <ul id="side-menu" class="nav">
                         ...
                         <li><a href="ManageAcount.aspx"><i class="fa fa-sitemap fa-fw">
                            <div class="icon-bg bg-blue"></div>
                        </i><span class="menu-title">Account</span></a>                          
                        </li>                       
                          <li><a href="ManageCategory.aspx"><i class="fa fa-th-list fa-fw">
                            <div class="icon-bg bg-blue"></div>
                        </i><span class="menu-title">Category</span></a>                          
                        </li>
                        <li><a href="ManageProduct.aspx"><i class="fa fa-database fa-fw">
                            <div class="icon-bg bg-orange"></div>
                        </i><span class="menu-title">Product</span></a>                            
                        <li><a href="SalePersonViewOder.aspx"><i class="fa fa-file-o fa-fw">
                            <div class="icon-bg bg-blue"></div>
